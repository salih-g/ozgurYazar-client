<template>
	<section>
		<div class="about">
			<h1>Selam !</h1>
			<p>
				Issız,yalnız, puslu bir gecede yürürken kaybolmuş bir ürperti
				hissedersin, o ürperti her saniye koşarak sana yaklaşır. Bir baykuşun
				çığlığına yıldızlar eşlik eder ama milyonlarca kilometre uzakta olan bu
